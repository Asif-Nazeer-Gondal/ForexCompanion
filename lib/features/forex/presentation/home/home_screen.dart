// lib/features/forex/presentation/home/home_screen.dart

import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
// Import the necessary providers and model
import '../../forex_providers.dart'; // Import the providers file
import '../../domain/models/forex_rate.dart'; // Ensure this path is correct
...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // 1. WATCH the correct provider: liveRatesProvider
    final forexDataAsync = ref.watch(liveRatesProvider);
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () => ref.invalidate(liveRatesProvider), // Invalidate the correct provider
          ),
        ],
      ),
